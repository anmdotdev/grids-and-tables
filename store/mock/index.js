...
const getSortedResults = (sortValue, data, allData) => {
  ...
  switch (sortValue) {
    ...
    case 'date_ascending': {
      newData = data.sort((first, second) => compareAsc(new Date(first.date), new Date(second.date)));
      break;
    }
    case 'date_descending': {
      newData = data.sort((first, second) => compareDesc(new Date(first.date), new Date(second.date)));
      break;
    }
    default: {
