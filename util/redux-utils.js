...
export const apiInitiate = async (type, dispatch, data = {}) => dispatch({ type, apiStatus: API_STATUS.INITIATED, data: { ...data } });

export const apiSuccess = async (type, dispatch, data = {}) => dispatch({ type, apiStatus: API_STATUS.SUCCESS, data: { ...data } });

export const apiFailure = async (type, dispatch, data = {}) => dispatch({ type, apiStatus: API_STATUS.FAILURE, data: { ...data } });
